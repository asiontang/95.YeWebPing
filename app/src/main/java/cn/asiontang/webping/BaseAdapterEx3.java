...
public abstract class BaseAdapterEx3<T> extends BaseAdapterEx<T>
{
    ...
    public static final class ViewHolder
    {
        ...
        public final Checkable getCheckableView(final int viewId)
        {
            return this.getView(viewId);
        }
        ...
        public final GridView getGridView(final int viewId)
        {
            return this.getView(viewId);
        }
        ...
        public MultiAutoCompleteTextView getMultiAutoCompleteTextView(final int viewId)
        {
            return this.getView(viewId);
        }
        ...
        public Spinner getSpinner(final int viewId)
        {
            return this.getView(viewId);
        }
        ...
        public WebView getWebView(final int viewId)
        {
            return this.getView(viewId);
        }
    }
